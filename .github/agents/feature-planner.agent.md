...
> Reply with **"approve"** or **"APPROVE"** to create a GitLab issue from this plan in the `vans23/taskmanager-copilot-lab` project.  
...
- ALWAYS use `vans23/taskmanager-copilot-lab` as the GitLab project when creating issues.
